...
export const RESEARCH_REPORTS: ResearchReport[] = [
  ...
  },
  {
    ...
    readMinutes: 45,
    chapters: 12,
    href: '/_reports/japan-consumer-2026.html',
    highlights: [
  ...
  {
    id: 'food-medicine-homology-2026',
    title: '食药同源 · 出海全赛道产业尽调研究报告',
    subtitle: '全球食药同源市场全景：业态演化 · 区域优先级 · 产业链上中下游壁垒',
    date: '2026-07-03',
    region: '全球',
    category: '尽调',
    readMinutes: 40,
    chapters: 8,
    href: '/_reports/food-medicine-homology-2026.html',
    highlights: [
      '全球三阶段演化：传统草本 → 膳食补充剂全球化 → 监管收紧/临床循证',
      '区域优先级：北美（资本+品类双高地）/ 德国（适应原崛起）/ 东南亚（文化共振双位数爆发）',
      '产业链上中下游壁垒：GAP标准化提取 / 仙乐健康CDMO范式 / 跨境电商渠道',
      '$2,650 亿市场规模 · 欧盟/东南亚高增速 · DSHEA+GRAS+FDA 合规路径',
    ],
    metrics: [
      { label: '全球市场', value: '$2,650 亿' },
      { label: '章节', value: '8' },
      { label: '主要区域', value: '6 大区' },
      { label: '合规路径', value: '3 种' },
    ],
  },
  {
